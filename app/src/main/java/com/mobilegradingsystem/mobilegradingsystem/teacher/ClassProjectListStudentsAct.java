...
public class ClassProjectListStudentsAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
        studentListTeacherRecyclerViewAdapter  = new ProjectStudentsClassRecordRecyclerViewAdapter(context,studentClassObjectModelArrayList,partKey);
    ...
    void getStudents(){
        db.collection("studentClasses").whereEqualTo("classCode",classKey).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
