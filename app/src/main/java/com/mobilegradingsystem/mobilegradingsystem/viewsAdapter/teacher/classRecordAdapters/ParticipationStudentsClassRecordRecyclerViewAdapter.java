...
public class ParticipationStudentsClassRecordRecyclerViewAdapter
        extends RecyclerView.Adapter<ParticipationStudentsClassRecordRecyclerViewAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                db.collection("participationCategory").document(partKey).addSnapshotListener(new EventListener<DocumentSnapshot>() {
                    @Override
                    public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
              ...
              try {
                  if (!inputGrade.getText().toString().equals(null)){
                      if (Integer.parseInt(inputGrade.getText().toString()) < 0){
                          ...
                          String key = db.collection("participation").document().getId();
