                        ...
                        public void onSuccess(Uri uri) {
                           ...
                           .update("userImage",uri.toString()).addOnSuccessListener(new OnSuccessListener<Void>() {
                               ...
                               public void onSuccess(Void aVoid) {
                                   GlideApp.with(UpdateProfilePicture.this).load(FirebaseAuth.getInstance().getCurrentUser().getPhotoUrl()).centerCrop().diskCacheStrategy(DiskCacheStrategy.ALL).into(circleImageView);
                                   finish();
                               }
                           });
