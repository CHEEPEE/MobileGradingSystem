...
public class QuizLongTestStudentsClassRecordRecyclerViewAdapter
        extends RecyclerView.Adapter<QuizLongTestStudentsClassRecordRecyclerViewAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                db.collection("quizLongTestCategory").document(partKey).addSnapshotListener(new EventListener<DocumentSnapshot>() {
                    @Override
                    public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
              ...
              try {
                  if (!inputGrade.getText().toString().equals(null)){
                      if (Integer.parseInt(inputGrade.getText().toString()) < 0){
                          ...
                          String key = db.collection("quizLongTest").document().getId();
